...
Pig::Pig(GLfloat xi,GLfloat yi,GLfloat zi,AnimateSpriteSheet* ssheet){//Provisional, se debería proveer direction y speed
    ...
    this->z=zi;
    this->sprites = ssheet;
    this->width=ssheet->states[PIG_HEALTHY].begin()->c2.y - ssheet->states[PIG_HEALTHY].begin()->c1.y;
    this->width=ssheet->states[PIG_HEALTHY].begin()->c2.x - ssheet->states[PIG_HEALTHY].begin()->c1.x;
