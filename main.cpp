...
bool init()
{
	...
	else
	{
		...
		//Create window
		gWindow = SDL_CreateWindow( "WILSON VOLTEA A JAFETH IDA Y VUELTA 360°", SDL_WINDOWPOS_UNDEFINED, SDL_WINDOWPOS_UNDEFINED, ancho_ventana, largo_ventana, SDL_WINDOW_SHOWN );
		if( gWindow == NULL )
		{
...
//---------------------------------CREACION DEL PAJARO----------------------------------------------------------
        ...
        Poligono1.SetAsBox(30.0f,30.f); //TAMAÑOS
